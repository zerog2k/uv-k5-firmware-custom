...
#define PWM_PLUS1_BASE_ADDR 0x400B4800U
...
#define PWMPLUS_GEN_CH1N_OE_SHIFT               27U
#define PWMPLUS_GEN_CH1N_OE_WIDTH               1U
#define PWMPLUS_GEN_CH1N_OE_VALUE_ENABLE        1U
#define PWMPLUS_GEN_CH1N_OE_BITS_ENABLE         (PWMPLUS_GEN_CH1N_OE_VALUE_ENABLE << PWMPLUS_GEN_CH1N_OE_SHIFT)

#define PWMPLUS_GEN_CH1_OE_SHIFT                26U
#define PWMPLUS_GEN_CH1_OE_WIDTH                1U
#define PWMPLUS_GEN_CH1_OE_VALUE_ENABLE         1U
#define PWMPLUS_GEN_CH1_OE_BITS_ENABLE          (PWMPLUS_GEN_CH1_OE_VALUE_ENABLE << PWMPLUS_GEN_CH1_OE_SHIFT)

#define PWMPLUS_GEN_CH0N_OE_SHIFT               25U
#define PWMPLUS_GEN_CH0N_OE_WIDTH               1U
#define PWMPLUS_GEN_CH0N_OE_VALUE_ENABLE        1U
#define PWMPLUS_GEN_CH0N_OE_BITS_ENABLE         (PWMPLUS_GEN_CH0N_OE_VALUE_ENABLE << PWMPLUS_GEN_CH0N_OE_SHIFT)
...
#define PWMPLUS_GEN_CH1N_OUTINV_SHIFT           19U
#define PWMPLUS_GEN_CH1N_OUTINV_WIDTH           1U
#define PWMPLUS_GEN_CH1N_OUTINV_VALUE_ENABLE    1U
#define PWMPLUS_GEN_CH1N_OUTINV_BITS_ENABLE     (PWMPLUS_GEN_CH1N_OUTINV_VALUE_ENABLE << PWMPLUS_GEN_CH1N_OUTINV_SHIFT)

#define PWMPLUS_GEN_CH1_OUTINV_SHIFT            18U
#define PWMPLUS_GEN_CH1_OUTINV_WIDTH            1U
#define PWMPLUS_GEN_CH1_OUTINV_VALUE_ENABLE     1U
#define PWMPLUS_GEN_CH1_OUTINV_BITS_ENABLE      (PWMPLUS_GEN_CH1_OUTINV_VALUE_ENABLE << PWMPLUS_GEN_CH1_OUTINV_SHIFT)

#define PWMPLUS_GEN_CH0N_OUTINV_SHIFT           17U
#define PWMPLUS_GEN_CH0N_OUTINV_WIDTH           1U
#define PWMPLUS_GEN_CH0N_OUTINV_VALUE_ENABLE    1U
#define PWMPLUS_GEN_CH0N_OUTINV_BITS_ENABLE     (PWMPLUS_GEN_CH0N_OUTINV_VALUE_ENABLE << PWMPLUS_GEN_CH0N_OUTINV_SHIFT)
...
#define PWMPLUS_GEN_CH1_START_SHIFT             9U
#define PWMPLUS_GEN_CH1_START_WIDTH             1U
#define PWMPLUS_GEN_CH1_START_VALUE_ENABLE      1U
#define PWMPLUS_GEN_CH1_START_BITS_ENABLE       (PWMPLUS_GEN_CH1N_START_VALUE_ENABLE << PWMPLUS_GEN_CH1N_START_SHIFT)

#define PWMPLUS_GEN_CH1N_IDLE_SHIFT              3U
#define PWMPLUS_GEN_CH1N_IDLE_WIDTH              1U
#define PWMPLUS_GEN_CH1N_IDLE_VALUE_ENABLE       1U
#define PWMPLUS_GEN_CH1N_IDLE_BITS_ENABLE        (PWMPLUS_GEN_CH1N_IDLE_VALUE_ENABLE << PWMPLUS_GEN_CH1N_IDLE_SHIFT)
...
#define PWM_PLUS1_CFG_ADDR          (PWM_PLUS1_BASE_ADDR + PWMPLUS_CFG)
#define PWM_PLUS1_CFG               (*(volatile uint32_t *)PWM_PLUS1_CFG_ADDR)

#define PWM_PLUS1_GEN_ADDR          (PWM_PLUS1_BASE_ADDR + PWMPLUS_GEN)
#define PWM_PLUS1_GEN               (*(volatile uint32_t *)PWM_PLUS1_GEN_ADDR)

#define PWM_PLUS1_CLKSRC_ADDR       (PWM_PLUS1_BASE_ADDR + PWMPLUS_CLKSRC)
#define PWM_PLUS1_CLKSRC            (*(volatile uint32_t *)PWM_PLUS1_CLKSRC_ADDR)

#define PWM_PLUS1_BRAKE_CFG_ADDR    (PWM_PLUS1_BASE_ADDR + PWMPLUS_BRAKE_CFG)
#define PWM_PLUS1_BRAKE_CFG         (*(volatile uint32_t *)PWM_PLUS1_BRAKE_CFG_ADDR)

#define PWM_PLUS1_MASK_LEV_ADDR     (PWM_PLUS1_BASE_ADDR + PWMPLUS_MASK_LEV)
#define PWM_PLUS1_MASK_LEV          (*(volatile uint32_t *)PWM_PLUS1_MASK_LEV_ADDR)

#define PWM_PLUS1_PERIOD_ADDR       (PWM_PLUS1_BASE_ADDR + PWMPLUS_PERIOD)
#define PWM_PLUS1_PERIOD            (*(volatile uint32_t *)PWM_PLUS1_PERIOD_ADDR)

#define PWM_PLUS1_CH0_COMP_ADDR     (PWM_PLUS1_BASE_ADDR + PWMPLUS_CH0_COMP)
#define PWM_PLUS1_CH0_COMP          (*(volatile uint32_t *)PWM_PLUS1_CH0_COMP_ADDR)

#define PWM_PLUS1_CH1_COMP_ADDR     (PWM_PLUS1_BASE_ADDR + PWMPLUS_CH1_COMP)
#define PWM_PLUS1_CH1_COMP          (*(volatile uint32_t *)PWM_PLUS1_CH1_COMP_ADDR)

#define PWM_PLUS1_CH2_COMP_ADDR     (PWM_PLUS1_BASE_ADDR + PWMPLUS_CH2_COMP)
#define PWM_PLUS1_CH2_COMP          (*(volatile uint32_t *)PWM_PLUS1_CH2_COMP_ADDR)

#define PWM_PLUS1_CH0_DT_ADDR       (PWM_PLUS1_BASE_ADDR + PWMPLUS_CH0_DT)
#define PWM_PLUS1_CH0_DT            (*(volatile uint32_t *)PWM_PLUS1_CH0_DT_ADDR)

#define PWM_PLUS1_CH1_DT_ADDR       (PWM_PLUS1_BASE_ADDR + PWMPLUS_CH1_DT)
#define PWM_PLUS1_CH1_DT            (*(volatile uint32_t *)PWM_PLUS1_CH1_DT_ADDR)

#define PWM_PLUS1_CH2_DT_ADDR       (PWM_PLUS1_BASE_ADDR + PWMPLUS_CH2_DT)
#define PWM_PLUS1_CH2_DT            (*(volatile uint32_t *)PWM_PLUS1_CH2_DT_ADDR)

#define PWM_PLUS1_TRIG_COMP_ADDR    (PWM_PLUS1_BASE_ADDR + PWMPLUS_TRIG_COMP)
#define PWM_PLUS1_TRIG_COMP         (*(volatile uint32_t *)PWM_PLUS1_TRIG_COMP_ADDR)

#define PWM_PLUS1_TRIG_CFG_ADDR     (PWM_PLUS1_BASE_ADDR + PWMPLUS_TRIG_CFG)
#define PWM_PLUS1_TRIG_CFG          (*(volatile uint32_t *)PWM_PLUS1_TRIG_CFG_ADDR)

#define PWM_PLUS1_IE_ADDR           (PWM_PLUS1_BASE_ADDR + PWMPLUS_IE)
#define PWM_PLUS1_IE                (*(volatile uint32_t *)PWM_PLUS1_IE_ADDR)

#define PWM_PLUS1_IF_ADDR           (PWM_PLUS1_BASE_ADDR + PWMPLUS_IF)
#define PWM_PLUS1_IF                (*(volatile uint32_t *)PWM_PLUS1_IF_ADDR)

#define PWM_PLUS1_SWLOAD_ADDR       (PWM_PLUS1_BASE_ADDR + PWMPLUS_SWLOAD)
#define PWM_PLUS1_SWLOAD            (*(volatile uint32_t *)PWM_PLUS1_SWLOAD_ADDR)

#define PWM_PLUS1_MASK_EN_ADDR      (PWM_PLUS1_BASE_ADDR + PWMPLUS_MASK_EN)
#define PWM_PLUS1_MASK_EN           (*(volatile uint32_t *)PWM_PLUS1_MASK_EN_ADDR)

#define PWM_PLUS1_CNT_ST_ADDR       (PWM_PLUS1_BASE_ADDR + PWMPLUS_CNT_ST)
#define PWM_PLUS1_CNT_ST            (*(volatile uint32_t *)PWM_PLUS1_CNT_ST_ADDR)

#define PWM_PLUS1_BRAKE_ST_ADDR     (PWM_PLUS1_BASE_ADDR + PWMPLUS_BRAKE_ST)
#define PWM_PLUS1_BRAKE_ST          (*(volatile uint32_t *)PWM_PLUS1_BRAKE_ST_ADDR)
